...
function check_wsample_wrep(
        a::AbstractArray, vrgn, wv::AbstractWeights, ptol::Real;
...
@testset "validation of inputs" begin
    ...
    for f in (
            sample!, wsample!, naive_wsample_norep!, efraimidis_a_wsample_norep!,
            efraimidis_ares_wsample_norep!, efraimidis_aexpj_wsample_norep!,
        )
