...
@test_approx_eq StatsBase.mad!([1:5;], 3) 1.4826022185056018
@test_approx_eq mad([1:5;]) 1.4826022185056018
@test_approx_eq mad(1:5) 1.4826022185056018
@test_approx_eq StatsBase.mad!([1:5;], constant=1.0) 1.0
@test_approx_eq StatsBase.mad!([1:5;], 3, constant=1.0) 1.0

# Issue 197
@test_approx_eq mad(1:2) 0.7413011092528009
