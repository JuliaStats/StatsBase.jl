...
* `indicators(a)`: Encode categories using one-hot scheme aka one-of-C encoding, indicator matrix or dummy variables. Assumes that categories are encoded as integers in the range [1, c], where c is the number of categories (or classes).
